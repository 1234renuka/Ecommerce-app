...
const Placeorder = () => {
  ...
  const onSubmitHandler = async (event) =>{
     ...
     try {
         ...
         const cartSubtotal = await getCartAmount();  // getCartAmount is probably async
        ...
        case 'razorpay':{
          ...
          if(responseRazorpay.data.success){
            initPay(responseRazorpay.data.order, responseRazorpay.data.key);  // 🛠️ pass order and key
          } else {
